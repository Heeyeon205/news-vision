INSERT INTO users (username, password, nickname, role, badge_id)
VALUES ('admin', 'admin', '뉴션', 'ROLE_ADMIN', 1),
...
VALUES ('admin_badge', '뉴션', 'ROLE_ADMIN'),
...
VALUES ('AI 뉴스 대폭발', 'AI 관련 뉴스 본문입니다.', 1, NOW(), 15, 2), -- admin
...
VALUES (10, '관리자 뉴스 1일 전', '본문입니다.', 1, NOW() - INTERVAL 1 DAY, 23, '/images/news1.jpg', 1),
...
INSERT INTO news (news_id, title, content, category_id, created_at, view, image, user_id)
VALUES (20, '크리에이터1 뉴스 1일 전', '본문입니다.', 1, NOW() - INTERVAL 1 DAY, 8, '/images/news11.jpg', 2),
