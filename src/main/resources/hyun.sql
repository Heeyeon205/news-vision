...
VALUES ('admin', 'admin', '뉴션', 'ROLE_ADMIN', 1),
       ('creator', 'creator', '크리에이터', 'ROLE_CREATOR', 2);
...
VALUES ('AI 뉴스 대폭발', 'AI 관련 뉴스 본문입니다.', 2, NOW(), 15, 1),
       ('테슬라 신모델 발표', '테슬라 뉴스 내용입니다.', 3, NOW(), 22, 1),
       ('경제전망 하락세', '경제 뉴스입니다.', 4, NOW(), 8, 1),
       ('우주 산업의 미래', '우주 뉴스입니다.', 5, NOW(), 10, 2),
       ('새로운 인터넷 밈 등장', '밈 관련 소식입니다.', 6, NOW(), 5, 2),
